...
namespace Website.Controllers
{
    public class PostsController : Controller
    {
        ...
        {
            ViewData["BlogId"] = new SelectList(_context.Blogs, nameof(Blog.BlogId), nameof(Blog.Url));
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PostId,Title,Content,BlogId")] Post post)
        {
            ...
            ViewData["BlogId"] = new SelectList(_context.Blogs, "BlogId", nameof(Blog.Url), post.BlogId);
            return View(post);
        }
